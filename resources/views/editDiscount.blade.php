...
<div class="content-wrapper">
    ...
    <form method="post" action="{{action('DiscountController@update', $id)}}" enctype='multipart/form-data'>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" name="title" value="{{$discount->title}}" class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="text" name="percentage" required class="form-control" value="{{$discount->percentage}}" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<option @if($discount->condition =='<') selected=select" @endif value="<"> < </option>
							<option @if($discount->condition =='>') selected=select" @endif value=">"> > </option>
							</select>
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="number"  min="1" max="100" value="{{$discount->age}}" name="age" class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="date" name="from" value="{{$discount->from}}" class="form-control" style="width:100%;" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<input type="date" name="to" value="{{$discount->to}}" class="form-control" style="width:100%;" >
